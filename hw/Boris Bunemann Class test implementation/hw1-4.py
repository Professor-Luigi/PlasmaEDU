...
if __name__ == '__main__':
    ...
    ## Test the class implementation of boris-bunemann integration
    ...
    bb = BB(time, X0, Q, M, Efield, Bfield)
    X_uncorrected = bb.X_nc
    X_corrected = bb.X_c
    ...
    # Make a sampled analytic fn to calculate the absolute errors
    analytic_x_sampled, analytic_y_sampled = analytic(time, r_L, wc=omega_c)
